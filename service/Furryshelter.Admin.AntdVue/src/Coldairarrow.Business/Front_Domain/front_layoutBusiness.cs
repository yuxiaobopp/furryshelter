...
namespace Coldairarrow.Business.Front_Domain
{
    ...
    /// 前端页面布局，页面菜单按钮获取接口
    /// </summary>
    public class front_layoutBusiness : BaseBusiness<front_user>, Ifront_userBusiness, ITransientDependency
    {
        readonly IOperator _operator;
        readonly IMapper _mapper;
        public front_layoutBusiness(IDbAccessor db, IOperator @operator, IMapper mapper)
            : base(db)
        {
            _operator = @operator;
            _mapper = mapper;
