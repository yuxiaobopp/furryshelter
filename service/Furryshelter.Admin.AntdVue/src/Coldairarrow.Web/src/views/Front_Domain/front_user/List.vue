          ...
          <a-col :md="4" :sm="24">
            <a-form-item label="查询类别">
              <a-select allowClear v-model="queryParam.condition">
                ...
                <a-select-option key="IdentityCardNo">身份证实名</a-select-option>
...
const columns = [
  ...
  { title: '电话号码', dataIndex: 'Phone', width: '10%' },
  { title: '身份证实名', dataIndex: 'IdentityCardNo', width: '10%' },
  { title: '否已实名', dataIndex: 'IfVerifyCardNo', width: '10%' },
  { title: '出生日期', dataIndex: 'Birthday', width: '10%' },
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.loading = true
      this.$http
        .post('/Front_Domain/front_user/GetDataList', {
      ...
      this.$confirm({
        ...
        onOk() {
          return new Promise((resolve, reject) => {
            thisObj.$http.post('/Front_Domain/front_user/DeleteData', ids).then(resJson => {
              resolve()
